...
/**
 * Servlet implementation class RefreshTableController
 */
@WebServlet("/RefreshTableController")
public class RefreshTableController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RefreshTableController() {
        super();
